...
export default function AddToDoForm({ onSubmit }: AddTodoFormProps) {
    ...
    return (
        <form className="flex  gap-2 pb-8 m-auto sm:w-11/12   " onSubmit={handleSubmit}>
            ...
            <button
                type="submit"
                className="rounded-3xl bg-blue-600 p-3 xs:px-4 md:px-5 md:py-3 text-white text-sm md:text-base lg:text-lg hover:bg-blue-700 transition transform hover:scale-105">
                Add
            </button>
        </form>
    );
